...
|                          | subtitle v            | Value of subtitle field                                  | string                                           |
...
| **human**                |                       | **human-friendly time output**                           |                                                  |
|                          | clock                 | Current clock, in (hh:mm:ss)                             | string                                           |
|                          | duration              | Duration of current timer, in (hh:mm:ss)                 | string                                           |
|                          | expectedEnd           | Time expected to finish, in (hh:mm:ss)                   | string                                           |
|                          | runningTimer          | Current running timer in (hh:mm:ss)                      | string                                           |
|                          | elapsedTime           | Elapsed time of current timer in (hh:mm:ss)              | string                                           |
|                          | startedAt             | Time when the current time started (hh:mm:ss)            | string                                           |
|                          |                       |                                                          | string                                           |
